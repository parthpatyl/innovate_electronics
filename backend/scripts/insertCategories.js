...
// MongoDB connection string - using the same config as server.js
const MONGODB_URI = process.env.MONGO_URI || process.env.MONGODB_URI || 'mongodb://localhost:27017/innovate_electronics';
...
module.exports = { insertCategories, transformCategoriesData }; 